...
public class TlosModMenus {
	...
	public static final DeferredHolder<MenuType<?>, MenuType<TestingSwordGUIMenu>> TESTING_SWORD_GUI = REGISTRY.register("testing_sword_gui", () -> IMenuTypeExtension.create(TestingSwordGUIMenu::new));
}
