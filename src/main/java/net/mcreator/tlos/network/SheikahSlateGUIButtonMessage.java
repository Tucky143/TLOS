...
import net.mcreator.tlos.procedures.StasisProcedure;
import net.mcreator.tlos.procedures.RemoteBombsProcedure;
import net.mcreator.tlos.procedures.MasterCycleProcedure;
import net.mcreator.tlos.procedures.MagnesisProcedure;
import net.mcreator.tlos.procedures.CryonisProcedure;
...
public record SheikahSlateGUIButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		TlosMod.addNetworkMessage(SheikahSlateGUIButtonMessage.TYPE, SheikahSlateGUIButtonMessage.STREAM_CODEC, SheikahSlateGUIButtonMessage::handleData);
	}
}
