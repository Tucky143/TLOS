...
import net.mcreator.tlom.network.UseRuneMessage;
import net.mcreator.tlom.network.OpenSheikahSlateGUIMessage;

@EventBusSubscriber(bus = EventBusSubscriber.Bus.MOD, value = {Dist.CLIENT})
public class TlomModKeyMappings {
	public static final KeyMapping OPEN_SHEIKAH_SLATE_GUI = new KeyMapping("key.tlom.open_sheikah_slate_gui", GLFW.GLFW_KEY_R, "key.categories.ui") {
	...
	public static final KeyMapping USE_RUNE = new KeyMapping("key.tlom.use_rune", GLFW.GLFW_KEY_X, "key.categories.gameplay") {
		private boolean isDownOld = false;
