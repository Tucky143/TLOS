...
import net.mcreator.tlom.procedures.UseRuneOnKeyPressedProcedure;
...
public record UseRuneMessage(int eventType, int pressedms) implements CustomPacketPayload {
	public static final Type<UseRuneMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(TlomMod.MODID, "key_use_rune"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		TlomMod.addNetworkMessage(UseRuneMessage.TYPE, UseRuneMessage.STREAM_CODEC, UseRuneMessage::handleData);
	}
}
