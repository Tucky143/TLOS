package net.mcreator.tlom.client.gui;
...
import net.mcreator.tlom.network.SheikahSlateGUIButtonMessage;
...
public class SheikahSlateGUIScreen extends AbstractContainerScreen<SheikahSlateGUIMenu> {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("tlom:textures/screens/sheikah_slate_gui.png");
	...
	public void init() {
		...
		imagebutton_remote_bomb = new ImageButton(this.leftPos + 36, this.topPos + 70, 64, 64,
				new WidgetSprites(ResourceLocation.parse("tlom:textures/screens/remote_bomb.png"), ResourceLocation.parse("tlom:textures/screens/remote_bomb_hovered.png")), e -> {
					if (true) {
		...
		imagebutton_magnesis = new ImageButton(this.leftPos + 135, this.topPos + 70, 64, 64, new WidgetSprites(ResourceLocation.parse("tlom:textures/screens/magnesis.png"), ResourceLocation.parse("tlom:textures/screens/magnesis_hovered.png")), e -> {
			if (true) {
		...
		imagebutton_stasis = new ImageButton(this.leftPos + 225, this.topPos + 70, 64, 64, new WidgetSprites(ResourceLocation.parse("tlom:textures/screens/stasis.png"), ResourceLocation.parse("tlom:textures/screens/stasis_hovered.png")), e -> {
			if (true) {
		...
		imagebutton_cryonis = new ImageButton(this.leftPos + 315, this.topPos + 70, 64, 64, new WidgetSprites(ResourceLocation.parse("tlom:textures/screens/cryonis.png"), ResourceLocation.parse("tlom:textures/screens/cryonis_hovered.png")), e -> {
			if (true) {
		...
		imagebutton_master_cycle_zero = new ImageButton(this.leftPos + 180, this.topPos + -2, 64, 64,
				new WidgetSprites(ResourceLocation.parse("tlom:textures/screens/master_cycle_zero.png"), ResourceLocation.parse("tlom:textures/screens/master_cycle_zero_hovered.png")), e -> {
					if (true) {
