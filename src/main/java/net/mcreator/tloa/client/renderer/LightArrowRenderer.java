...
public class LightArrowRenderer extends EntityRenderer<LightArrowEntity> {
	private static final ResourceLocation texture = ResourceLocation.parse("tloa:textures/entities/light_arrow.png");
	...
	@Override
	public void render(LightArrowEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
