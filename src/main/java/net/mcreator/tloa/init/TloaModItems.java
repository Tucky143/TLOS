...
import net.mcreator.tloa.item.FrostspearItem;
...
public class TloaModItems {
	...
	public static final DeferredItem<Item> GREAT_THUNDERBLADE = REGISTRY.register("great_thunderblade", GreatThunderbladeItem::new);
