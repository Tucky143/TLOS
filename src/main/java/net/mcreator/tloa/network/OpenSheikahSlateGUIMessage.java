...
import net.mcreator.tloa.procedures.OpenSheikahSlateGUIOnKeyPressedProcedure;
...
public record OpenSheikahSlateGUIMessage(int eventType, int pressedms) implements CustomPacketPayload {
	public static final Type<OpenSheikahSlateGUIMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(TloaMod.MODID, "key_open_sheikah_slate_gui"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		TloaMod.addNetworkMessage(OpenSheikahSlateGUIMessage.TYPE, OpenSheikahSlateGUIMessage.STREAM_CODEC, OpenSheikahSlateGUIMessage::handleData);
	}
}
