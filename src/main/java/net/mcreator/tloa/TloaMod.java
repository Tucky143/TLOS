...
@Mod("tloa")
public class TloaMod {
	public static final Logger LOGGER = LogManager.getLogger(TloaMod.class);
	public static final String MODID = "tloa";

	public TloaMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		TloaModSounds.REGISTRY.register(modEventBus);
		TloaModBlocks.REGISTRY.register(modEventBus);

		TloaModItems.REGISTRY.register(modEventBus);
		TloaModEntities.REGISTRY.register(modEventBus);
